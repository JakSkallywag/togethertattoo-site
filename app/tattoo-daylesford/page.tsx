      ...
      <main className="min-h-screen bg-black text-white pt-16">
        ...
        <section className="px-6 py-16 border-t border-gray-800 max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              <strong className="text-white">By car:</strong> Castlemaine is about 30 minutes from Daylesford via the Midland Highway. Head north through Hepburn Springs and follow signs to Castlemaine. Free street parking is available right outside the studio on Halford Street.
            </p>
            <p>
