...
export const metadata: Metadata = {
  title: "Tattoo Studio Near Bendigo | Together Tattoo, Castlemaine",
  description:
    "Looking for a tattoo artist near Bendigo? Together Tattoo is a custom tattoo studio in Castlemaine, just 40 minutes from Bendigo by car or train. Fine line, blackwork, botanical, and lino print-inspired tattoos.",
  keywords: [
    "tattoo Bendigo",
    "tattoo artist Bendigo",
    "tattoo studio near Bendigo",
    "Bendigo tattoo",
    "custom tattoo Bendigo",
    "tattoo central Victoria",
    "tattoo Castlemaine",
    "Together Tattoo",
  ],
  alternates: {
    canonical: "/tattoo-bendigo",
  },
};

const portfolioImages = [
  { src: "/portfolio/jak/05-forearm-Gum.jpg", alt: "Gum leaf tattoo by Jak Rapmund" },
  { src: "/portfolio/pip/piptattoo07.jpg", alt: "Lino print-inspired tattoo by Pip" },
  { src: "/portfolio/jak/09-forearm-finelinetext.jpg", alt: "Fine line text tattoo by Jak Rapmund" },
  { src: "/portfolio/pip/piptattoo02.jpg", alt: "Block print tattoo by Pip" },
  { src: "/portfolio/jak/03-Back-Monstera.jpg", alt: "Monstera tattoo by Jak Rapmund" },
  { src: "/portfolio/pip/piptattoo08.jpg", alt: "Printmaking tattoo by Pip" },
];
