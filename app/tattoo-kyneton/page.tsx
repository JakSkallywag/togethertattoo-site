      ...
      <main className="min-h-screen bg-[#1a1a1a] text-[#e8e4dc] pt-16">
        ...
        <section className="px-6 py-16 border-t border-[#2e2e2e] max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-[#aaaaaa]">
            <p>
              <strong className="text-[#e8e4dc]">By car:</strong> Castlemaine is about 20 minutes from Kyneton via the Calder Freeway. Head north and take the Castlemaine exit. Free street parking is available right outside the studio on Halford Street.
            </p>
            <p>
              <strong className="text-[#e8e4dc]">By train:</strong> V/Line runs regular services from Kyneton to Castlemaine, taking about 15 minutes. The studio is a short walk from Castlemaine station.
            </p>
            <p>
